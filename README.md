...
A local search server that gives AI agents free web search and page reading without any API keys. Runs on `localhost:8000` and is used as a tool backend by [Trout](https://github.com/ByteTheBait/trout).
